...
static void hid_device_removal_callback(void *context, IOReturn result,
                                        void *sender)
{
    MONUnusedParameter(result);
    MONUnusedParameter(sender);
                                ...
                                uint8_t *report, CFIndex report_length)
{
    MONUnusedParameter(sender);
    MONUnusedParameter(result);
    MONUnusedParameter(report_type);
    MONUnusedParameter(report_id);
...
{
    /* TODO: */
    MONUnusedParameter(dev);
    MONUnusedParameter(string_index);
    MONUnusedParameter(string);
    MONUnusedParameter(maxlen);
